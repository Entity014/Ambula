...
def main():
    ...
    ctrl.pos_gain            = 1.0
    ctrl.vel_gain            = 0.02 * axis.motor.config.torque_constant * axis.encoder.config.cpr # 0.025 [R] 0.05 [L]
    ctrl.vel_integrator_gain = 0.16 * axis.motor.config.torque_constant * axis.encoder.config.cpr # 0.16 [R] 0.18 [L]
