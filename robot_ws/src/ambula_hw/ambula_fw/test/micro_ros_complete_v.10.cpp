...
void leftLegCallback(const void *msgin)
{
    ...
    left_leg_msg.y = left_leg_msg.y + maps[0].pos0_raw;
    left_leg_msg.z = left_leg_msg.z + maps[1].pos0_raw;
}
...
void rightLegCallback(const void *msgin)
{
    auto *m = (const geometry_msgs__msg__Point *)msgin;
    right_leg_msg = *m;
    right_leg_msg.y = right_leg_msg.y + maps[3].pos0_raw;
    right_leg_msg.z = right_leg_msg.z + maps[4].pos0_raw;
}
